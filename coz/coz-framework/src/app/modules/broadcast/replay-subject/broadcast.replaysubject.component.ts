...
@Component({
    moduleId: module.id,
    selector: 'broadcast-replay-subject',
    templateUrl: './broadcast.replaysubject.component.html',
    styleUrls: ['../css/broadcast.css']
})

export class BroadcastReplaySubjectComponent implements OnInit, OnDestroy { 
    private subject : ReplaySubject<number> = new ReplaySubject();
    message : string = '\n';
