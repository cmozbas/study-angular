...
export class CustomReuseStrategy implements RouteReuseStrategy {
  ...
  store(route: ActivatedRouteSnapshot, handle: DetachedRouteHandle): void {
    ...
    // routes are stored by path - the key is the path name, and the handle is stored under it so that you can
    // only ever have one object stored for a single path
